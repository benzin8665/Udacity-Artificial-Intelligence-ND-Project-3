"""
Abuhanif Bhuiyan: Project-3 AIND program Feb 2018
Finished  all TODO items in this file My_planning_graph.py to complete the Planning-Master project, then
tested and includeed the results in my report.
...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        """
        #  Added action A level to the planning graph as described in the Russell-Norvig text
        ...
        for action in self.all_actions:
            ...
            # Checked if its preconditions satisfied by the previous level
            if action_node.prenodes.issubset(previous_s_level):
                # Added to the list of action nodes
                action_nodes.append(action_node)

                # Connected to previous level's relevant state nodes
    ...
    def add_literal_level(self, level):
        ...
        """
        # Added literal S level to the planning graph as described in the Russell-Norvig text
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        # Tested for Inconsistent Effects between nodes
        # Tested for Inconsistent Effects between nodes
        # Checked if one action negates an effect of the other
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """      
        # Tested for Interference between nodes
        # Checked if one of the effects of one action is the negation of a precondition of the other
        for node_a1_effect in node_a1.action.effect_add:
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        # Tested for Competing Needs between nodes
        # Tested for Competing Needs between nodes
        # Checked if one of the preconditions of one action is mutually exclusive with a
    ...
    def negation_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s) -> bool:
        ...
        :return: bool
        """
        # Tested for negation between nodes
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        :return: bool
        """
        # Tested for Inconsistent Support between nodes
